...
![diagram-export-3-23-2025-9_09_26-AM](https://github.com/user-attachments/assets/fff510e0-800e-45f1-b161-3b0cf0bad3a6)
...
- **7. Chatbot Buddy**  
  ...
  - ![image](https://github.com/user-attachments/assets/ece3d66b-02a9-4d04-90e5-9621e31559bb)


#### 🌸 Mermaid Diagram: Shakti SOS in Action  
```mermaid
graph TD
    A[You Hit SOS] --> B[OTP to Contacts]
    B --> C[Live Stream: Audio/Video/Location]
    C --> D[Alarm Blasts + Torch Flashes]
    D --> E[Contact Confirms OTP]
    E --> F[SOS Stops]
    A --> G[Phone Snatched?]
    G --> H{Internet On?}
    H -->|Yes| I[Full SOS Sent]
    H -->|No| J[SMS with Last Location]
    J --> K[5 Route Predictions + Police Stations]
```
...
- **Why It’s Different**: Offline simulations, tailored tips, and doc magic—no one does it like this!
  -![image](https://github.com/user-attachments/assets/62b9c107-3272-434f-9fce-37a565e6d9a7)
...
```mermaid
sequenceDiagram
    You->>Shree: Snap Bill Photo
    Shree->>Backend: Process Image
    Backend-->>Shree: Sorted Data + Insights
    Shree->>You: “Cut Coffee, Save ₹200!”
    You->>Shree: Try UPI Simulation
    Shree-->>You: Step-by-Step Guide
```

#### 🌸 Mermaid Diagram: Shree Simulation Flow  
```mermaid
graph TD
    A[Pick Tool: UPI] --> B[Load Simulation]
    B --> C[Step 1: Enter Amount]
    C --> D[Step 2: Scan QR]
    D --> E[Step 3: Confirm]
    E --> F[Success Animation]
```
...
- **1. Skills Matching**  
  ...
  - ![image](https://github.com/user-attachments/assets/509f6390-2c6f-401b-8ebf-d2884863cf87)
...
```mermaid
graph TD
    A[You: “I sew!”] --> B[AI Scans Skills]
    B --> C[Mentor: Sewing Pro]
    B --> D[Event: Fabric Workshop]
    B --> E[Job: Tailor Gig]
    C --> F[Chat Mentor]
    D --> G[Join Event]
    E --> H[Apply Now]
...
```mermaid
flowchart LR
    A[Goal: Coder] --> B[Quiz: Python Basics]
    B --> C[Lesson: Loops]
    C --> D[Video: Code Tips]
    D --> E[Mentor Session]
    E --> F[Progress: 50%]
...
classDiagram
    ...
    NodeBackend --> Database : MongoDB/PostgreSQL
```
...
```mermaid
graph TD
    A[React Native App] --> B[Shakti: Safety]
    A --> C[Shree: Finance]
    A --> D[Sakhi: Skills]
    B --> E[Snatch Detection]
    C --> F[Simulation Tool]
    D --> G[Roadmap Engine]
```
...
sequenceDiagram
    You->>Website: Login
    Website->>Backend: “Who’s this?”
    Backend-->>Website: “It’s HER!”
    Website-->>You: Shakti/Shree/Sakhi Dashboard
```

---
![image](https://github.com/user-attachments/assets/56f875c2-f739-4a84-b4d7-29d87b65ea54)

![image](https://github.com/user-attachments/assets/e2b47095-abed-4be4-9f39-6f90e6fac17b)
...
```mermaid
graph TD
    A[You’re Offline] --> B[Local Storage]
    B --> C[Add Data]
    C --> D[Queue It Up]
    D --> E{Internet Back?}
    E -->|Yes| F[Sync to Backend]
    E -->|No| G[Chill in Queue]
```
...
![image](https://github.com/user-attachments/assets/b37b2e56-4e71-4497-b8f9-814245f29a83)
